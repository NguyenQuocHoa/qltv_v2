...
import { Col, Image, message, Row, Upload } from "antd";
...
const UploadSingleImage = props => {
	...
	const uploadProps = {
		...
		// action: `${prefix}api/upload-image`,
		action: `http://localhost:6165/api/Book/upload-image`,
		headers: {
			Authorization: sid
		},
		accept: "image/*",
		onChange(info) {
			...
			if (info.file.status === "done") {
				...
				if (mode == 2) {
					setPreviewImage(info.file.response?.data[0]?.image_link);
				}

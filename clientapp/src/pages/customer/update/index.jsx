...
const UpdateCustomer = props => {
	const { success, customerPayload, dispatch } = props;
	...
	const handleSubmit = payload => {
		...
		if (!phoneInValid && !emailInValid) {
			...
			dispatch({
				type: "customerUpdate/updateCustomerRequest",
				payload: payload
			});
		}
	};
	...
	useEffect(() => {
		dispatch({
			type: "customerDetail/getCustomerDetailRequest",
...
const mapStateToProps = state => {
	return {
		success: state.customerDetail.success,
		customerPayload: state.customerDetail.payload,
		loading:
			state.loading.effects["customerUpdate/getCustomerUpdateRequest"]
	};
};

...
const UpdateBook = props => {
	...
	const handleSubmit = payload => {
		...
		dispatch({
			type: "bookCategoryUpdate/updateBookCategoryRequest",
			payload: convertPayload
		});
	};

	useEffect(() => {
		if (updateBookCategorySuccess) {
			dispatch({
				type: "bookCategoryUpdate/clearState"
			});
			history.goBack();
		}
	}, [updateBookCategorySuccess]);
	...
	useEffect(() => {
		dispatch({
			type: "bookCategoryDetail/getBookCategoryDetailRequest",
			id: +props.match.params.id
		});
	}, []);
...
const mapStateToProps = state => {
	return {
		updatePayload: state.bookCategoryUpdate.payload,
		updateBookCategorySuccess: state.bookCategoryUpdate.success,
		detailPayload: state.bookCategoryDetail.payload,
		getDetailSuccess: state.bookCategoryDetail.success
	};
};

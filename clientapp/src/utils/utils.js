...
export const EROLE = [
	...
	{ id: 2, name: "NHOMNHANVIEN", path: "/staffGroups" },
	{ id: 3, name: "PHANQUYEN", path: "/delegates" },
	{ id: 4, name: "NHOMQUYEN", path: "/pgs" },
	{ id: 5, name: "DUAN", path: "/projects" },
	{ id: 6, name: "BAOCAO", path: "/report" },
	{ id: 7, name: "BAOCAOMOINHAT", path: "/latest-reports" },
	{ id: 8, name: "FILE", path: "/folders" },
	{ id: 9, name: "KHACHHANG", path: "/customers" },
	{ id: 10, name: "BACKLOG", path: "/backlogs" }
];
